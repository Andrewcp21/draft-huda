  ...
  return (
    <div className="min-h-screen flex flex-col items-center relative overflow-hidden bg-[#FFDE3D] pt-30">
      ...
      <div className={`flex-grow flex flex-col items-center justify-center w-full p-4`}>
        <div className="text-left mb-4 max-w-sm mx-auto p-4">
          <p className="text-md text-black">Setelah kami kumpulkan data-nya, 1 dari 10 orang yang menerima email mendaftarkan diri mereka ke promosi kami. Berdasarkan analisa tim marketing, 15% dari pendaftar akhirnya menjadi pelanggan kafe kami. Kalau bulan depan kami berharap ada 300 pelanggan, berapa perkiraan email yang harus kami kirimkan?</p>
        </div>

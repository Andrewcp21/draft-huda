...
const M2Q2Scene: React.FC<M2Q2SceneProps> = ({ onBack, onNext }) => {
  ...
  const fullText = "Hebat! Sama dengan sebelumnya, silakan gunakan kalkulator dibawah untuk menjawab.";
    ...
    <div className="h-screen w-full flex flex-col bg-[#FFDE3D] relative overflow-hidden">
        ...
        <div className={`w-full max-w-md mx-auto flex flex-col p-4 transition-all duration-500 ease-in-out ${
          ...
          <div className="bg-white rounded-2xl shadow-2xl p-4 sm:p-6">
            ...
            <div className="grid grid-cols-4 gap-2 sm:gap-3">
              ...
              <button className={`${buttonBaseClasses} ${buttonSizeClasses} bg-yellow-400 text-black`} onClick={handleBackspaceClick}>⌫</button>
      ...
      <div className="w-full max-w-md mx-auto p-4 z-10 bg-[#FFDE3D] fixed bottom-0 left-0 right-0">
        <div className="flex flex-row gap-4 w-full">
          ...
          <button 
            onClick={() => {
              const score = (display === correctAnswers.M2Q2) ? 1 : 0;
              onNext(score);
            }}
